...
* We now natively support Linux and macOS systems with x86_64/amd64, arm64/aarch64, and powerpc64le CPUs 
...
* We fixed a bug that could make the game crash while logging karma physics errors
